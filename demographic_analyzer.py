import pandas as pd 
def analyze_demographic_data(print_data=True):
    ...
    q3=df['hours-per-week']==min_work_hours
    rich_percentage=round((q3&q2).sum()/q3.sum()*100,1)
    ...
    top_IN_occupation=df[(df['native-country']=='India')&q2]['occupation'].value_counts().index[0]
